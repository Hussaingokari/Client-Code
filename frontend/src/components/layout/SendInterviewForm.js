...
export default function SendInterviewForm() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {/* ONLINE INTERVIEW */}
      <div className="bg-[var(--bg-card)] border border-[var(--border-main)] rounded-lg p-6">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-2">
            <Mail size={24} className="text-blue-500" />
            <h2 className="text-lg font-medium text-[var(--text-main)] ">Online Interview</h2>
          </div>
          <p className="text-sm text-[var(--text-light)] ">Send online interview invitation via email</p>
        </div>

        <form onSubmit={handleSendOnlineInterview} className="flex flex-col gap-4">
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Candidate Name</label>
            <input
              type="text"
              name="candidateName"
              ...
              required
              className="w-full px-3 py-2 border border-[var(--border-main)] bg-[var(--bg-card)] text-[var(--text-main)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60"
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Job Title</label>
            <input
              type="text"
              name="jobTitle"
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Interview Date</label>
            <input
              type="date"
              name="interviewDate"
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Interview Time</label>
            <input
              type="time"
              name="interviewTime"
  ...
  >
    ...
    <option value="Other">Other</option>
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Meeting Link</label>
            <input
              type="url"
              name="meetingLink"
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Meeting ID</label>
            <input
              type="text"
              name="meetingId"
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Passcode</label>
            <input
              type="text"
              name="passcode"
          ...
          <div className="flex gap-3 justify-end pt-4 border-t border-[var(--border-main)] ">
            <button type="button" onClick={() => setOnlineData({ candidateName: '', recipientEmail: '', jobTitle: '', interviewDate: '', interviewTime: '', platform: '', meetingLink: '', meetingId: '', passcode: '' })} disabled={onlineLoading} className="px-4 py-2 border border-[var(--border-main)] rounded-lg text-sm font-medium text-[var(--text-light)] hover:bg-[var(--bg-app)] disabled:opacity-60">CANCEL</button>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border-main)] rounded-lg p-6">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-2">
            <Mail size={24} className="text-blue-500" />
            <h2 className="text-lg font-medium text-[var(--text-main)] ">Offline Interview</h2>
          </div>
          <p className="text-sm text-[var(--text-light)] ">Send offline interview invitation via email</p>
        </div>
        ...
        <form onSubmit={handleSendOfflineInterview} className="flex flex-col gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-2">Venue Address</label>
            <textarea
              name="venueAddress"
              ...
              disabled={offlineLoading}
              required
              className="w-full px-3 py-2 border border-[var(--border-main)] bg-[var(--bg-card)] text-[var(--text-main)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60 min-h-20"
            />
          </div>
          ...
          <div className="flex gap-3 justify-end pt-4 border-t border-[var(--border-main)] ">
            <button type="button" onClick={() => setOfflineData({ candidateName: '', recipientEmail: '', jobTitle: '', interviewDate: '', interviewTime: '', venueAddress: '', cityLocation: '' })} disabled={offlineLoading} className="px-4 py-2 border border-[var(--border-main)] rounded-lg text-sm font-medium text-[var(--text-light)] hover:bg-[var(--bg-app)] disabled:opacity-60">CANCEL</button>
