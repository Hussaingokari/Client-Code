...
export default function ThemeToggle({ variant = 'pill' }) {
    ...
    return (
      <button 
        ...
        style={{
          ...
          color: 'var(--text-light)', padding: '6px', transition: 'color 0.2s',
        }}
  ...
  return (
    <div style={{
      display: 'flex', alignItems: 'center', background: 'var(--bg-muted)', 
      ...
      <button 
        ...
        style={{
          ...
          color: !isDark ? '#0f172a' : 'var(--text-light)',
      ...
      <button 
        ...
        style={{
          ...
          color: isDark ? 'white' : 'var(--text-light)',
          padding: '6px 14px', borderRadius: '20px', border: 'none', cursor: 'pointer',
          fontSize: '12px', fontWeight: '600', transition: 'all 0.2s',
