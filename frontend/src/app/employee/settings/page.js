...
//                 padding: '10px 0', borderBottom: '1px solid var(--border-main)',
//               }}>
  ...
  return (
    <div style={{ marginBottom: '24px' }}>
      ...
      <div style={{ display: 'grid', gridtemplateColumns: '1fr 1fr', gap: '20px' }}>
        ...
        <div style={{
          padding: '20px', background: 'linear-gradient(135deg, #1e3a5f, #2563eb)', color: 'white',
        }}>
          <h3 style={{ fontSize: '15px', fontWeight: '700' }}>🔒 Change Password</h3>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            marginTop: '16px', padding: '12px', background: '#8f8faf', borderRadius: '8px',
            border: '1px solid #bfdbfe',
          }}>
          ...
          <form onSubmit={handleChangePassword}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                ...
                <span style={{ fontSize: '12px', color: met6chars ? '#16a34a' : '#94a3b8' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                ...
                <span style={{ fontSize: '12px', color: metMatch ? '#16a34a' : '#94a3b8' }}>
                  Passwords match
                </span>
              </div>
            </div>
            ...
            >
              {changing ? (
                <>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                    stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="9" y="1" width="11" height="11" rx="2" ry="2" />
                    <path d="M7 17v-5" />
                    <path d="M4 14h3" />
                  </svg>
                  Changing...
