    ...
    <div>
        ...
        {[
          ...
          <div key={i} style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
              <span style={{ fontSize: '12px', color: 'var(--text-light)', fontWeight: '500' }}>{s.label}</span>
      ...
      <div style={{
        ...
        <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-main)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h3 style={{ fontSize: '15px', fontWeight: '700', color: 'var(--text-main)' }}>Attendance History</h3>
          <span style={{ fontSize: '12px', color: 'var(--text-lighter)' }}>{records.length} records</span>
        </div>
