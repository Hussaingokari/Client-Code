...
export default function EmployeeOnboardingChecklistPage() {
    ...
    if (!onboarding) {
        return (
            <div style={{ background: 'var(--bg-card)', borderRadius: '12px', border: '1px solid var(--border-main)', padding: '60px', textAlign: 'center' }}>
                <div style={{ fontSize: '14px', fontWeight: '600', color: 'var(--text-main)' }}>No onboarding checklist yet</div>
            </div>
        );
    }
    ...
    return (
        <div>
            ...
            <div style={{ marginBottom: '20px', height: '8px', background: 'var(--bg-muted)', borderRadius: '4px', overflow: 'hidden' }}>
                <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                {/* Pending box */}
                <div style={{ background: 'var(--bg-card)', borderRadius: '14px', border: '1px solid var(--border-main)', padding: '20px' }}>
