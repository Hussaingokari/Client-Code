  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '20px' }}>
        {/* Recent Activity */}
        <div style={{ background: 'var(--bg-card)', borderRadius: '12px', border: '1px solid var(--border-main)', padding: '18px 20px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
            ...
            data.recentActivity.map((item, i) => (
              <div key={i} style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '12px', color: 'var(--text-light)' }}>{item.description}</div>
                </div>
          ...
          {QUICK_ACTIONS.map((a, i) => (
            <button
              ...
              style={{
                ...
                background: 'var(--bg-card)', border: '1px solid var(--border-main)', borderRadius: '10px',
