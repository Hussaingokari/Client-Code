    ...
    return (
        <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                <div>
                    <div style={{ fontSize: '20px', fontWeight: '800', color: 'var(--text-main)' }}>Notifications</div>
                    <div style={{ fontSize: '13px', color: 'var(--text-lighter)', marginTop: '2px' }}>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <div style={{ fontSize: '13px', fontWeight: n.read ? '600' : '800', color: 'var(--text-main)' }}>
                                        {n.title}
                                    </div>
                                    {n.message && (
