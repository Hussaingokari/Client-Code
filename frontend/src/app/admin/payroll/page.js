  ...
  return (
    <div>
      ...
      <div style={{
        ...
        border: '1px solid var(--border-main)', marginBottom: '20px',
        ...
        <select
          ...
          style={{
            padding: '8px 14px', border: '1.5px solid var(--border-main)',
            borderRadius: '8px', fontSize: '13px', outline: 'none',
            background: 'var(--bg-card)', fontWeight: '500',
          }}
        >
          {MONTHS.map((m, i) => (
        ...
        <button
          ...
          style={{
            padding: '8px 20px', background: 'var(--bg-sidebar)',
        ...
        <div style={{ display: 'flex', gap: '14px', marginBottom: '20px' }}>
          {[
            ...
            <div key={i} style={{
              ...
              padding: '16px', border: '1px solid var(--border-main)',
              boxShadow: '0 1px 4px rgba(0,0,0,0.04)',
            }}>
            ...
            <div key={p.id} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '11px', color: 'var(--text-lighter)' }}>{p.employeeCode}</div>
                </div>
              </div>
            ...
            <form onSubmit={handleGenerate}>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <select
                  ...
                  required
                  style={{ width: '100%', padding: '10px 12px', border: '1.5px solid var(--border-main)', borderRadius: '10px', fontSize: '13px', outline: 'none', background: 'var(--bg-card)' }}
                >
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <button type="submit" disabled={generating}
                  style={{ flex: 1, padding: '12px', background: 'var(--bg-sidebar)', color: 'white', border: 'none', borderRadius: '10px', fontSize: '14px', fontWeight: '700', cursor: generating ? 'not-allowed' : 'pointer', opacity: generating ? 0.7 : 1 }}>
