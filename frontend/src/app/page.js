...
export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-slate-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 transition-colors duration-500">
      ...
      <div className="w-full max-w-3xl mx-auto relative z-10 backdrop-blur-xl bg-white/80 dark:bg-slate-900/70 border border-cyan-500/20 dark:border-cyan-400/25 px-14 pt-8 pb-12 rounded-[32px] shadow-[0_25px_80px_rgba(0,170,255,0.08)] dark:shadow-[0_25px_80px_rgba(0,170,255,0.15)] flex flex-col items-center transition-all duration-500">
        ...
        <div className="w-16 h-[2px] rounded-full bg-gradient-to-r from-transparent via-cyan-500 dark:via-cyan-400 to-transparent mt-1 mb-3"></div>

        <div className="flex flex-col items-center mb-4">
          <p className="text-base font-extrabold text-amber-500 dark:text-yellow-400 uppercase tracking-[0.45em] mb-3">
            WORKSPACE
          </p>
          <div className="flex items-center gap-2 text-[11px] text-cyan-600/70 dark:text-cyan-400/70 font-medium uppercase tracking-widest">
            <span>Streamline</span>
            <span className="w-1 h-1 rounded-full bg-amber-500 dark:bg-yellow-400"></span>
            <span>Manage</span>
            <span className="w-1 h-1 rounded-full bg-amber-500 dark:bg-yellow-400"></span>
            <span>Empower</span>
          </div>
        ...
        <div className="w-24 h-[2px] rounded-full bg-gradient-to-r from-transparent via-cyan-500 dark:via-cyan-400 to-transparent mb-5"></div>

        <p className="text-xs font-semibold text-cyan-600/80 dark:text-cyan-400/80 mb-5 uppercase tracking-wider">Select Your Portal</p>

        <Link
          href="/login/employee"
          aria-label="Employee Portal"
          className="group w-full flex items-center gap-5 py-6 px-8 mb-4 rounded-[16px] border border-cyan-500/30 dark:border-cyan-500/40 bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800/70 hover:border-cyan-500/50 dark:hover:border-cyan-500/60 hover:-translate-y-1 transition-all duration-300 cursor-pointer shadow-sm dark:shadow-lg hover:shadow-[0_0_45px_rgba(34,211,238,0.15)] dark:hover:shadow-[0_0_45px_rgba(34,211,238,0.30)] focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-slate-900"
        >
          <div className="w-[72px] h-[72px] rounded-[14px] bg-white dark:bg-slate-700/50 border border-amber-400/40 dark:border-yellow-400/40 flex items-center justify-center shrink-0 transition-all duration-300 group-hover:border-amber-500 dark:group-hover:border-yellow-300 group-hover:bg-slate-50 dark:group-hover:bg-slate-700/70 group-hover:scale-110">
            <User
              size={42}
              className="text-amber-500 dark:text-yellow-400 drop-shadow-[0_0_10px_rgba(255,180,0,.25)] dark:drop-shadow-[0_0_10px_rgba(255,215,0,.5)] transition-all duration-300 group-hover:scale-110"
            />
          </div>
          <div className="flex-1 text-left">
            <div className="text-xl font-bold text-slate-800 dark:text-white mb-0.5 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 transition-colors">Employee Portal</div>
            <div className="text-base font-medium text-slate-500 dark:text-cyan-400/60">Access your personal dashboard</div>
          </div>
          <div className="w-14 h-14 rounded-full border border-cyan-500/30 dark:border-cyan-500/40 flex items-center justify-center group-hover:border-cyan-500/50 dark:group-hover:border-cyan-500/60 transition-all">
            <ChevronRight
              size={28}
              className="text-cyan-600 dark:text-cyan-400 transition-all duration-300 group-hover:text-cyan-500 dark:group-hover:text-cyan-300 group-hover:translate-x-1"
            />
          </div>
        </Link>
        ...
        <Link
          href="/login/admin"
          aria-label="HR Admin Portal"
          className="group w-full flex items-center gap-5 py-6 px-8 mb-8 rounded-[16px] border border-cyan-500/30 dark:border-cyan-500/40 bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800/70 hover:border-cyan-500/50 dark:hover:border-cyan-500/60 hover:-translate-y-1 transition-all duration-300 cursor-pointer shadow-sm dark:shadow-lg hover:shadow-[0_0_45px_rgba(34,211,238,0.15)] dark:hover:shadow-[0_0_45px_rgba(34,211,238,0.30)] focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-slate-900"
        >
          <div className="w-[72px] h-[72px] rounded-[14px] bg-white dark:bg-slate-700/50 border border-amber-400/40 dark:border-yellow-400/40 flex items-center justify-center shrink-0 group-hover:border-amber-500 dark:group-hover:border-yellow-300 group-hover:bg-slate-50 dark:group-hover:bg-slate-700/70 transition-all">
            <ShieldCheck
              size={42}
              className="text-amber-500 dark:text-yellow-400 drop-shadow-[0_0_10px_rgba(255,180,0,.25)] dark:drop-shadow-[0_0_10px_rgba(255,215,0,.5)] transition-all duration-300"
            />
          </div>
          <div className="flex-1 text-left">
            <div className="text-xl font-bold text-slate-800 dark:text-white mb-0.5 group-hover:text-cyan-600 dark:group-hover:text-cyan-300 transition-colors">HR / Admin Portal</div>
            <div className="text-base font-medium text-slate-500 dark:text-cyan-400/60">Manage system and personnel</div>
          </div>
          <div className="w-14 h-14 rounded-full border border-cyan-500/30 dark:border-cyan-500/40 flex items-center justify-center group-hover:border-cyan-500/50 dark:group-hover:border-cyan-500/60 transition-all">
            <ChevronRight
              size={28}
              className="text-cyan-600 dark:text-cyan-400 transition-all duration-300 group-hover:text-cyan-300 group-hover:translate-x-1"
            />
          </div>
        </Link>
        ...
        <div className="flex flex-col items-center mt-6 text-center">
          ...
          <p className="text-[9px] font-medium text-cyan-700/70 dark:text-cyan-300/70 uppercase tracking-widest mt-1">
            All rights reserved.
          </p>
        </div>
      </div>
