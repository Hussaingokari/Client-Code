...
emailService.sendEmailWithAttachment(
    ...
    private String wrapWithHtmlStyling(String candidateName, String emailBody) {
        return "<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f5f5f5; padding: 20px;\">"
                ...
                +
                "<h1 style=\"color: white; margin: 0; font-size: 28px; font-weight: bold;\">🏢 PAXSAT BUSINESS SOLUTIONS PVT LTD</h1>"
                +
                ...
                "<p style=\"color: #2a5298; font-size: 13px; margin: 5px 0 0 0;\">© 2026 PAXSAT BUSINESS SOLUTIONS PVT LTD. All rights reserved.</p>"
                +
                "</div>" +
                "</div>" +
                "</div>";
